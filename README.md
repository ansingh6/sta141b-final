...
- Distribution of these animals appear more in the south central region of the United states, and in areas with higher population density. Visualizations of the data aid in giving context and suggesting further analysis to take with the variables used. 
